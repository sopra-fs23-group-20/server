...
https://github.com/sopra-fs23-group-20/client/issues/115 <br />
https://github.com/sopra-fs23-group-20/client/issues/135 =>1 task for next week
#### Description:
implemented quickjoin, might have to work on the alert (already started at the 6 May) <br />
Adapted rules and quick tutorial to mobile <br />
added a cool landing page ;)
---
...
https://github.com/sopra-fs23-group-20/client/issues/147 <br />
https://github.com/sopra-fs23-group-20/server/issues/140 <br />
#### Description:
I added a first draft of the new game mode "Blitz", I fixed a bug where users could submit guess without entering a country, I fixed a visual bug that occured when only selecting antarctica in the regions section, and I added flashcards with animations to learn countries. I also wrote some tests for Game entity and GamePutDTO.
...
### Jonathan
https://github.com/sopra-fs23-group-20/client/issues/123 <br />
...
https://github.com/sopra-fs23-group-20/server/issues/141 <br />
https://github.com/sopra-fs23-group-20/client/issues/136 <br />
https://github.com/sopra-fs23-group-20/client/issues/154 <br />
...
### Jonas
https://github.com/sopra-fs23-group-20/client/issues/157 <br />
https://github.com/sopra-fs23-group-20/client/issues/158 <br />
https://github.com/sopra-fs23-group-20/client/issues/159 <br />
https://github.com/sopra-fs23-group-20/client/issues/160 <br />
https://github.com/sopra-fs23-group-20/client/issues/161 <br />
https://github.com/sopra-fs23-group-20/server/issues/141 <br />

#### Description:
I added a feature which lets the user know what the current hint is and what the next hint will be as well as in how many seconds the hint transitions to the next hint. <br />
I updated the readme to include the deployment for the frontend as well as the backend and I described the main components of the frontend as well as included screenshots of our game. <br />
I added some tests for the new game Mode "Blitz" to test the function which calculates the closest countries to the country to guess. <br />
